...
import type { InfoAttivita, SezioniData, TeamData, FaqData } from './types';
...
export class MockDataService {
  ...
  readonly sezioni$: Observable<SezioniData> = this.http
    .get<SezioniData>('/assets/mock/sezioni.json')
    .pipe(shareReplay(1));
